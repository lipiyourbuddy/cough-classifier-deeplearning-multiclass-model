...
TRAIN_DIR   = "Data/spectrograms_v2_split/train"
VAL_DIR     = "Data/spectrograms_v2_split/val"
IMG_SIZE    = (224, 224)
BATCH_SIZE  = 32
EPOCHS_P1   = 30
EPOCHS_P2   = 25
...
# ============================================================
# LOAD DATASETS — keep int labels for class_weight compatibility
# ============================================================
...
# ============================================================
# PIPELINE — stay with int labels, use sparse loss
# ============================================================
...
model.save("final_covidcoughnet_v4.keras")
print("\n✅ Final model saved → final_covidcoughnet_v4.keras")
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
            ...
            linewidths=0.5)
plt.title("Confusion Matrix — CovidCoughNet v4", fontsize=13)
...
plot_metric("accuracy", "Accuracy — v4", "curve_accuracy_v4.png")
plot_metric("loss",     "Loss — v4",     "curve_loss_v4.png")

print("\n✅ Done. Check confusion_matrix_v4.png and classification report above.")