...
input_base = "Data/COUGHVID_audio/"
output_base = "Data/COUGHVID_audio_pitch_shift_4/"
...
for c in classes:
    ...
    folder = os.path.join(input_base, c)
    ...
    for file in os.listdir(folder):
        ...
        if file.endswith(".wav"):
            ...
            pitch_shifted = librosa.effects.pitch_shift(y=signal, sr=sr, n_steps=-4)

            new_name = f"sample{counter}_{c}.wav"

            sf.write(os.path.join(output_base, new_name), pitch_shifted, sr)
...
audioDataPath = "Data/COUGHVID_audio/" #audioDataPath = "Data/wavs-silence-removed/"
